...
def setup_logging():
    ...
    if cfg.LOG_DEST == "stdout":
        ...
        logging_config["filename"] = os.path.join(cfg.PATHS.OUT_DIR, _LOG_FILE)
    # Configure logging
    logging.basicConfig(**logging_config)
    # ref: https://stackoverflow.com/questions/11029717/how-do-i-disable-log-messages-from-the-requests-library
